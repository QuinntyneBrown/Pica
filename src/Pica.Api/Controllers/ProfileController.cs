...
using Pica.Api.Features;
using MediatR;
using Microsoft.AspNetCore.Mvc;

namespace Pica.Api.Controllers
{
    [ApiController]
    ...
    public class ProfileController
    {
        ...
        [HttpPut("image",Name = "UpdateProfileImageRoute")]
        [ProducesResponseType((int)HttpStatusCode.InternalServerError)]
        [ProducesResponseType(typeof(ProblemDetails), (int)HttpStatusCode.BadRequest)]
        [ProducesResponseType(typeof(UpdateProfileImage.Response), (int)HttpStatusCode.OK)]
        public async Task<ActionResult<UpdateProfileImage.Response>> UpdateProfileImage([FromBody] UpdateProfileImage.Request request)
            => await _mediator.Send(request);

        [HttpPut("company-image", Name = "UpdateProfileCompanyImageRoute")]
        [ProducesResponseType((int)HttpStatusCode.InternalServerError)]
        [ProducesResponseType(typeof(ProblemDetails), (int)HttpStatusCode.BadRequest)]
        [ProducesResponseType(typeof(UpdateProfileCompanyImage.Response), (int)HttpStatusCode.OK)]
        public async Task<ActionResult<UpdateProfileCompanyImage.Response>> UpdateProfileCompanyImage([FromBody] UpdateProfileCompanyImage.Request request)
            => await _mediator.Send(request);
